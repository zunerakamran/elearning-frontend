...
function RatingBadge({ rating }) {
    ...
    return (
        <span className={`text-xs font-semibold px-2 py-1 rounded-full ${styles[rating] || 'bg-gray-100 text-gray-600'}`}>
            {rating}
        </span>
    );
}
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                    ...
                    <StatCard 
                        ...
                        icon={<svg className="w-6 h-6 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>}
                        color="bg-yellow-50" 
                    />
                    <StatCard 
                        label="Quizzes" 
                    ...
                    <div className="bg-white rounded-xl shadow p-5 mb-6">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            {['Excellent', 'Good', 'Average', 'Poor'].map((rating) => {
                                ...
                                return (
                                    <div key={rating} className={`${c.bg} rounded-lg p-4`}>
                                        <div className="flex justify-between items-center mb-2">
                                            <span className={`text-sm font-semibold ${c.text}`}>{rating}</span>
                ...
                <div className="flex gap-1 border-b border-gray-200 mb-4">
                    {tabs.map((tab) => (
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-medium border-b-2 transition -mb-px ${activeTab === tab.key
                                ...
                                <table className="w-full text-sm">
                                    <thead className="bg-gray-50 border-b">
                                        <tr>
                                            ...
                                            <th
                                                className="text-left px-4 py-3 font-semibold text-gray-600 cursor-pointer hover:text-indigo-600"
                            ...
                            <table className="w-full text-sm">
                                <thead className="bg-gray-50 border-b">
                                    <tr>
                                        ...
                                        <th className="text-left px-4 py-3 font-semibold text-gray-600">Attempted</th>
                                        <th className="text-left px-4 py-3 font-semibold text-gray-600">Pass Rate</th>
                                    ...
                                    {quiz_summaries.map((quiz) => {
                                        ...
                                        return (
                                            <tr key={quiz.id} className="border-b hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-3 text-gray-500">{quiz.lesson_title}</td>
                                                <td className="px-4 py-3 text-gray-600">{quiz.passing_score}%</td>
                                                <td className="px-4 py-3">
                                                ...
                                                <td className="px-4 py-3">
                                                    {difficulty ? (
                                                        <span className={`text-xs font-semibold px-2 py-1 rounded-full ${diffColor[difficulty]}`}>
                                                            {difficulty}
                                                        </span>
                                                    ) : <span className="text-gray-300">—</span>}
                                                </td>
                            ...
                            <table className="w-full text-sm">
                                <thead className="bg-gray-50 border-b">
                                    <tr>
                                        ...
                                        <th className="text-left px-4 py-3 font-semibold text-gray-600">Total Marks</th>
                                        ...
                                        <th className="text-left px-4 py-3 font-semibold text-gray-600">Graded</th>
                                        <th className="text-left px-4 py-3 font-semibold text-gray-600">Avg Marks</th>
                                        <th className="text-left px-4 py-3 font-semibold text-gray-600">Avg %</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {assignment_summaries.map((a) => (
                                        <tr key={a.id} className="border-b hover:bg-gray-50">
                                            ...
                                            <td className="px-4 py-3 text-gray-600">{a.total_marks}</td>
