            ...
            try {
                ...
                if (lessonInfo.content_type === 'quiz') {
                    try {
                        ...
                        // Fetch all attempts for admin
                        if (user?.role === 'admin' && quizRes.data?.id) {
                            try {
                                setAttemptsLoading(true);
                                const attemptsRes = await api.get(`/admin/quizzes/${quizRes.data.id}/attempts`);
                                                ...
                                                <table className="w-full text-sm">
                                                    <thead>
                                                        <tr className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                                                            ...
                                                            <th className="text-center px-5 py-3.5 font-semibold">Score</th>
                                                            <th className="text-center px-5 py-3.5 font-semibold">Result</th>
                                                            ...
                                                            <tr key={attempt.id} className="hover:bg-indigo-50/40 transition-colors duration-150">
                                                                ...
                                                                <td className="px-5 py-3.5">
                                                                    <div className="flex items-center gap-2.5">
                                                                        ...
                                                                        <span className="font-medium text-gray-900">{attempt.user?.name}</span>
                                                                    </div>
                                                                </td>
                                                                <td className="px-5 py-3.5 text-gray-500">{attempt.user?.email}</td>
