        ...
        const init = async () => {
            if (courseId && user?.role === 'student') {
                try {
                    ...
                    setShowSidebar(false); // open chat directly on mobile
                } catch (err) {
                    console.error(err);
                }
            }
        ...
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-5xl mx-auto px-4 py-4 sm:py-6">
                ...
                <div className="mb-4 flex items-center gap-3">
                    ...
                    {!showSidebar && (
                        <button
                            ...
                            className="sm:hidden flex items-center justify-center w-8 h-8 rounded-lg bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 flex-shrink-0"
                        >
                ...
                >
                    {/* ── Sidebar ─────────────────────────────────────────── */}
                    <div className={`
                        flex-col flex-shrink-0 border-r border-gray-100
                        w-full sm:w-72
                                ...
                                <div className="p-6 text-center">
                                    ...
                                    {user?.role === 'student' && (
                                        <p className="text-xs text-gray-300 mt-1">
                                            Go to a course and open the Chat tab
                                        </p>
                                    )}
                                </div>
                            ) : (
                                conversations.map((conv) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {/* Arrow — mobile hint */}
                                            <svg className="w-4 h-4 text-gray-300 flex-shrink-0 sm:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
