        ...
        <div className="bg-white rounded-lg shadow p-8 mb-6">
                  ...
                  {progress && (
                    <div>
                      ...
                      {progress.percentage === 100 && (
                        <p className="text-green-600 font-medium text-sm mt-2">🎉 Course completed!</p>
                      )}
                    </div>
                  )}
                </div>
          ...
          {isOwner && (
            <div className="flex gap-3">
              <Link to={`/courses/${id}/edit`} className="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">
                Edit Course
              </Link>
                            ...
                            <li key={lesson.id}>
                              {enrolled || isOwner ? (
                                <div className="flex items-center gap-3 p-2 rounded hover:bg-gray-50">
                                  ...
                                  {isOwner && lesson.content_type === 'quiz' && (
                                    <Link
                                      to={`/courses/${id}/lessons/${lesson.id}/quiz/create`}
